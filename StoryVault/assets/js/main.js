...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.protectPortalAccess = () => {
        ...
        const requiredRole = pageName === 'admin-dashboard.html' ? 'admin' :
                             ['member-dashboard.html', 'dashboard.html'].includes(pageName) ? 'member' : null;
    ...
    window.handlePortalLogin = (event) => {
        ...
        setTimeout(() => {
            window.location.href = authenticatedUser.role === 'admin' ? 'admin-dashboard.html' : 'dashboard.html';
        }, 650);
    };
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.handlePortalLogin = event => {
        ...
        setTimeout(() => window.location.href = role === 'admin' ? 'admin-dashboard.html' : 'dashboard.html', 550);
    };
